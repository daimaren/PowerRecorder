...
import com.mlingdu.demo.activity.MagicCameraActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
		...
		findViewById(R.id.btn_edit_demo).setOnClickListener(this);
    }
    ...
    private void shortVideo() {
        Intent intent = new Intent(MainActivity.this, MagicCameraActivity.class);
        startActivity(intent);
    }
}
